...
void mapper(char data[]){
    ...
    //char data[255] = "toast toast toast to to to jean to jean roger roger"; // ça marche avec cette salope
...
int main() {
    ...
    */
    ...
    // Cette conne foncitonne ALORS POURQUOI ÇA NE MARCHE PAS DANS LA FONCTION ???? BORDEL DE MERDE
